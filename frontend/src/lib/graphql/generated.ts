...
export type Mutation = {
    ...
    deleteExample?: Maybe<DeleteExamplePayload>
    /** Delete one file */
    ...
    updateExample?: Maybe<UpdateExamplePayload>
...
export type MutationUpdateExampleArgs = {
    input?: InputMaybe<UpdateExampleInput>
}
...
export type DeleteExamplePayload = {
    __typename?: 'deleteExamplePayload'
    example?: Maybe<Example>
}
...
export type UpdateExampleInput = {
    data?: InputMaybe<EditExampleInput>
}

export type UpdateExamplePayload = {
    __typename?: 'updateExamplePayload'
    example?: Maybe<Example>
}
...
export const Example = (
    options: Omit<WatchQueryOptions<ExampleQueryVariables>, 'query'>
): Readable<
    ApolloQueryResult<ExampleQuery> & {
        query: ObservableQuery<ExampleQuery, ExampleQueryVariables>
    }
> => {
